...
export function Galaxy({ solves }: { solves: Solve[] }) {
  ...
  return (
    <div className="w-full relative pointer-events-none p-4 md:p-8 flex items-center justify-center pb-12">
      <div className="w-full max-w-5xl h-auto glass-panel rounded-3xl p-6 md:p-10 flex flex-col relative overflow-hidden pointer-events-auto">
        {/* Background glow */}
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-6 lg:gap-8 z-10">
          <div className="flex-1 glass-panel rounded-2xl p-6 bg-white/5 max-h-[400px] lg:max-h-[500px] overflow-y-auto">
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-6">
            <div className="glass-panel rounded-2xl p-6 bg-white/5 max-h-[300px] lg:max-h-[380px] overflow-y-auto scrollbar-hide">
